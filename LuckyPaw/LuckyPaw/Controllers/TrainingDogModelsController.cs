...
namespace LuckyPaw.Controllers
{
    public class TrainingDogModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TrainingId,DogId,TrainerName,GraduationDate,TrainingType")] TrainingDogModel trainingDogModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TrainingId,DogId,TrainerName,GraduationDate,TrainingType")] TrainingDogModel trainingDogModel)
        {
